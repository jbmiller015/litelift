...
const AuthForm = () => {
    ...
    return (
        <div
             className="flex flex-col justify-center items-center p-4 md:p-12">
            ...
            <span className="absolute top-0 right-0 p-2" onClick={() => setError({})}>
                ...
                {loading ? (
                    ...
                    <div>
                        ...
                        <div className="mt-2 text-center text-gray-600">
                            ...
                            <a href="/demo" onClick={() => setToken('demoToken')} className="text-blue-500 hover:text-blue-700">
                                demo
                            </a>
                            {"."}
                        </div>
